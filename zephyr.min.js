 /** Zephyr * @version 0.1.4 min * @see https://github.com/Serrin/ * @license MIT */
...
const IsIntegralNumber=Number.isInteger||function(argument){return typeof argument==="number"&&isFinite(argument)&&Math.floor(argument)===argument;};
...
/** object header **/
const VERSION="Zephyr v0.1.4 min";
