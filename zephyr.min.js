...
function ArrayCreate(length=0){length=Number(length);if(1/length===-Infinity){length=0;}if(length>(Math.pow(2,32)-1)){throw new RangeError("Invalid array length: "+length);}return Array(length);}
